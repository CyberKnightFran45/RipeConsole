...
public static readonly Func<string, bool> BrotliFilter;

// BZip2 filter

public static readonly Func<string, bool> Bz2Filter;

// Lzma filter

public static readonly Func<string, bool> LzmaFilter;
...
private static readonly HashSet<string> BROTLI_EXT = new(StringComparer.OrdinalIgnoreCase)
{
".bin",
".brotli",
".br"
...
private static readonly HashSet<string> BZIP2_EXT = new(StringComparer.OrdinalIgnoreCase)
{
".bz2"
};
...
private static readonly HashSet<string> LZMA_EXT = new(StringComparer.OrdinalIgnoreCase)
{
".lzma"
};
...
BrotliFilter = PathHelper.CreateFileFilter(DEFAULT_NAMES, BROTLI_EXT);
Bz2Filter = PathHelper.CreateFileFilter(DEFAULT_NAMES, BZIP2_EXT);
LzmaFilter = PathHelper.CreateFileFilter(DEFAULT_NAMES, LZMA_EXT);
