...
ToolAction rtonEncodeAndEncrypt = new()
{
Name = "RTON Parser - Encode & Encrypt",
Execute = ActionInvoker.RTON_EncodeAndEncrypt,
FileFilter = FilterCriterias.JsonFilter,
AllowFiles = true,
AllowDirs = true
};

options.Add(15, rtonEncodeAndEncrypt);
...
ToolAction dzUnpack = new()
{
Name = "Marmalade DZip - Unpack",
Execute = ActionInvoker.Dz_Unpack,
FileFilter = FilterCriterias.DZipFilter,
AllowFiles = true
};

options.Add(49, dzUnpack);
...
ToolAction rawImgEncode = new()
{
Name = "Raw Image - Encode",
Execute = ActionInvoker.RawImg_Encode,
FileFilter = FilterCriterias.ImgFilter,
AllowFiles = true,
};

options.Add(86, rawImgEncode);

ToolAction rawImgDecode = new()
{
Name = "Raw Image - Decode",
Execute = ActionInvoker.RawImg_Decode,
FileFilter = FilterCriterias.BinFilter,
AllowFiles = true,
};

options.Add(87, rawImgDecode);
...
options.Add(141, zipUnpack);

ToolAction brotliCompress = new()
{
Name = "Brotli Compressor - Compress",
Execute = ActionInvoker.Brotli_Compress,
FileFilter = FilterCriterias.DefaultFilter,
AllowFiles = true,
AllowDirs = true
};

options.Add(142, brotliCompress);

ToolAction brotliDecompress = new()
{
Name = "Brotli Compressor - Decompress",
Execute = ActionInvoker.Brotli_Decompress,
FileFilter = FilterCriterias.BrotliFilter,
AllowFiles = true,
AllowDirs = true
};

options.Add(143, brotliDecompress);

ToolAction bz2Compress = new()
{
Name = "BZip2 Compressor - Compress",
Execute = ActionInvoker.Bz2_Compress,
FileFilter = FilterCriterias.DefaultFilter,
AllowFiles = true,
AllowDirs = true
};

options.Add(144, bz2Compress);

ToolAction bz2Decompress = new()
{
Name = "BZip2 Compressor - Decompress",
Execute = ActionInvoker.Bz2_Decompress,
FileFilter = FilterCriterias.Bz2Filter,
AllowFiles = true,
AllowDirs = true
};

options.Add(145, bz2Decompress);

ToolAction lzmaCompress = new()
{
Name = "Lzma Compressor - Compress",
Execute = ActionInvoker.Lzma_Compress,
FileFilter = FilterCriterias.DefaultFilter,
AllowFiles = true,
AllowDirs = true
};

options.Add(146, lzmaCompress);

ToolAction lzmaDecompress = new()
{
Name = "Lzma Compressor - Decompress",
Execute = ActionInvoker.Lzma_Decompress,
FileFilter = FilterCriterias.LzmaFilter,
AllowFiles = true,
AllowDirs = true
};

options.Add(147, lzmaDecompress);
...
options.Add(162, xorCrypt);

ToolAction adler32 = new()
{
Name = "Adler32 Checksum - Digest file",
Execute = ActionInvoker.Adler32_Digest,
FileFilter = FilterCriterias.DefaultFilter,
AllowFiles = true
};

options.Add(163, adler32);

ToolAction crc32 = new()
{
Name = "CRC-32 Checksum - Digest file",
Execute = ActionInvoker.Crc32_Digest,
FileFilter = FilterCriterias.DefaultFilter,
AllowFiles = true
};

options.Add(164, crc32);
...
options.Add(165, md5Hash);

// ======== RIPE hub ========

ToolAction about = new()
{
Name = "About Info",
Execute = _  => RipeHub.About(),
};

options.Add(170, about);

ToolAction openCfg = new()
{
Name = "Open App Settings",
Execute = _  => SettingsManager.Open(),
};

options.Add(171, openCfg);

ToolAction resetCfg = new()
{
Name = "Reset App Settings",
Execute = _  => SettingsManager.Reset(),
};

options.Add(172, resetCfg);

ToolAction openArgsEditor = new()
{
Name = "Open Arguments Editor",
Execute = _  => ArgsManager.Open(),
};

options.Add(173, openArgsEditor);

ToolAction resetArgs = new()
{
Name = "Reset Arguments Sheet",
Execute = _  => ArgsManager.Reset(),
};

options.Add(174, resetArgs);

ToolAction runtimeInfo = new()
{
Name = "Get Runtime Info",
Execute = _  => RipeHub.RuntimeInfoFull(),
};

options.Add(175, runtimeInfo);

ToolAction buildInfo = new()
{
Name = "Show Build Info",
Execute = _  => RipeHub.BuildInfo(),
};

options.Add(176, buildInfo);

ToolAction performance = new()
{
Name = "Show Perfomance",
Execute = _  => RipeHub.ShowPerformance(),
};

options.Add(177, performance);
}
